    ...
    <div className={`cart-item grid grid-cols-5 custom-sm:block custom-xs:block items-center pt-4 pb-6 border-b border-borderColor custom-xs:relative custom-sm:relative ${item.id === 1 ? 'pt-0' : 'pt-4'}`} data-aos="fade-up">
      ...
      <div className="text-center font-medium text-headingColor">
        <p className="flex items-center justify-center custom-sm:justify-start custom-xs:justify-start custom-sm:mt-5 custom-xs:mt-5">
          <span className="hidden custom-sm:block custom-xs:block mr-1">Price:</span>
          £{item?.price}
        </p>
      </div>
      {/* quantitty  */}
      ...
      <div className="text-center font-medium text-headingColor">
        <p className="flex items-center justify-center custom-sm:justify-start custom-sm:mt-5 custom-xs:justify-start custom-xs:mt-5">
            <span className="hidden custom-sm:block custom-xs:block mr-1">Subtotal: </span>£{subTotal}
        </p>
      </div>
      {/* remove  */}
      <div
