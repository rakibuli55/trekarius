...
const CheckoutPage = () => {
  ...
  const [shippingCost, setShippingCost] = useState(Number(24.99));
    ...
    if (data.paymentOptions === "paypal") {
      ...
      try {
        ...
        if (response?.status === 201) {
          toast.success("Checkout session created", { id: loadingToast });
          ...
          >
              ...
              <div>
                ...
                >
                  {countryData?.data?.map((country, index) => (
                    <option key={index} value={country?.slug?.toUpperCase()}>
                      {country?.name}
                    </option>
                  ))}
                </select>
            ...
            <div className="bg-white border rounded-[20px] p-10 w-[30%] max-md:w-full max-md:mt-5 custom-xs:p-5">
              ...
              <div className="payments--order-summary">
                ...
                {/* cupon card  */}
                {validCuponCodeData?.data?.code && (
                  <div
                    className="py-2 px-4 bg-primaryBlue rounded-[6px] mt-5 relative"
                  ...
                  >
                    ...
                    <p className="absolute top-1/2 translate-y-[-50%] right-4 h-5 w-5 flex items-center justify-center bg-[rgba(255,255,255,0.5)] rounded-full cursor-pointer duration-200 ease-in-out hover:bg-white">
                      <IoCloseOutline />
                    </p>
                  </div>
                )}
